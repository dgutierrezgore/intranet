        ...
        <div class="col-sm-12">
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                    <li class="active"><a href="#distribucion" data-toggle="tab" aria-expanded="true"><i
                                    class="fa fa-retweet"></i>
                            <strong>Recepción en Distribución</strong></a></li>
                    <li class=""><a href="#principal" data-toggle="tab" aria-expanded="false"><i
                                    class="fa fa-user"></i>
                                                ...
                                                @foreach($docs_dist as $listado)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            @elseif($listado->lectfuncdocint == 1)
                                                                <center><small class="label bg-green">LEIDO</small>
                                                                </center>
                                                            @endif
                                                            <center>
                                                                <form action='/FichaDocsInt' method='POST'>
