...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::post('/UnidInformatica/TraeDisponibilidadHard', 'UnidadInformaticaController@disponibilidad');
    Route::post('/UnidInformatica/GuardarReserva', 'UnidadInformaticaController@reservar');
